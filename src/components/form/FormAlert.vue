...
<template>
  <div>
    ...
    <div class="alert alert-dismissible d-flex align-items-center font-size-sm mt-4 mb-0" :class="alertType ? alertType : AlertType.Primary" role="alert">
      <Icon :type="alertType" />
      <div>
